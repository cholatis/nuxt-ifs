            ...
            <div class="panel">
                ...
                <div class="mb-5">
                    <div class="flex flex-col rounded-md border border-[#e0e6ed] dark:border-[#1b2e4b]">
                        ...
                        <div class="border-b border-[#e0e6ed] px-4 py-2.5 dark:border-[#1b2e4b]">Porta ac consectetur ac</div>
...
&lt;/div&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Links</h5>
...
&lt;/div&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Icons</h5>
                ...
                <div class="mb-5">
                    <div class="flex flex-col rounded-md border border-[#e0e6ed] dark:border-[#1b2e4b]">
                        <div class="flex border-b border-[#e0e6ed] px-4 py-2.5 hover:bg-[#eee] dark:border-[#1b2e4b] dark:hover:bg-[#eee]/10">
...
&lt;/div&gt;
            ...
            <div class="panel">
                <div class="mb-5 flex items-center justify-between">
                    <h5 class="text-lg font-semibold dark:text-white-light">Images</h5>
                    ...
                    <div class="flex flex-col rounded-md border border-[#e0e6ed] dark:border-[#1b2e4b]">
                        <div class="flex border-b border-[#e0e6ed] px-4 py-2.5 hover:bg-[#eee] dark:border-[#1b2e4b] dark:hover:bg-[#eee]/10">
                            <div class="ltr:mr-3 rtl:ml-3">
                                <img src="/assets/images/profile-1.jpeg" alt="" class="h-12 w-12 rounded-full object-cover" />
                            </div>
                            <div class="flex-1 font-semibold">
                        ...
                        <div class="flex px-4 py-2.5 hover:bg-[#eee] dark:hover:bg-[#eee]/10">
                            <div class="ltr:mr-3 rtl:ml-3">
                                <img src="/assets/images/profile-3.jpeg" alt="" class="h-12 w-12 rounded-full object-cover" />
                            </div>
                            <div class="flex-1 font-semibold">
...
&lt;/div&gt;
            ...
            <div class="panel">
                ...
                <div class="mb-5">
                    <div class="flex flex-col rounded-md border border-[#e0e6ed] dark:border-[#1b2e4b]">
                        <div
                            class="flex space-x-4 border-b border-[#e0e6ed] px-4 py-2.5 hover:bg-[#eee] rtl:space-x-reverse dark:border-[#1b2e4b] dark:hover:bg-[#eee]/10"
                        >
                            ...
                            <label for="tack_checkbox1" class="mb-0 cursor-pointer"
                                ...
                                <span class="badge my-auto bg-secondary hover:top-0 ltr:ml-3 rtl:mr-3">Project</span></label
                            >
                        </div>
                        <div
                        ...
                        >
                            ...
                            <label for="tack_checkbox2" class="mb-0 cursor-pointer"
                                >List groups are a flexible and powerful component for displaying simple.
                                <span class="badge my-auto bg-info hover:top-0 ltr:ml-3 rtl:mr-3">Urgent</span></label
                            >
                        </div>
                        <div class="flex space-x-4 px-4 py-2.5 hover:bg-[#eee] rtl:space-x-reverse dark:hover:bg-[#eee]/10">
                            <input id="tack_checkbox3" type="checkbox" class="form-checkbox" />
                            <label for="tack_checkbox3" class="mb-0 cursor-pointer"
                                >List groups are a flexible and powerful component for displaying simple.
                                <span class="badge my-auto bg-success hover:top-0 ltr:ml-3 rtl:mr-3">Success</span></label
                            >
                        </div>
                    </div>
                </div>
