                ...
                <div class="relative flex w-full flex-col items-center justify-center gap-6 px-4 pb-16 pt-6 sm:px-16 lg:max-w-[667px]">
                    ...
                    <div class="w-full max-w-[440px] lg:mt-16">
                        ...
                        <div v-if="currentStep === 0" class="space-y-5">
                            ...
                            <button @click="validateStep1" class="btn btn-gradient w-full border-0 uppercase shadow-[0_10px_20px_-10px_rgba(67,97,238,0.44)] mt-6">
                                Next Step
                            </button>
                        </div>
                        ...
                        <div v-if="currentStep === 1" class="space-y-5">
                            ...
                            <div class="flex gap-4 mt-6">
                                ...
                                <button @click="validateStep2" class="btn btn-gradient w-full border-0 uppercase shadow-[0_10px_20px_-10px_rgba(67,97,238,0.44)]">
                                    Next Step
                                </button>
                            </div>
                        </div>
