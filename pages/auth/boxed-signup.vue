                ...
                <div class="relative flex flex-col justify-center rounded-md bg-white/60 px-6 py-20 backdrop-blur-lg dark:bg-black/50 lg:min-h-[758px]">
                    ...
                    <div class="mx-auto w-full max-w-[440px]">
                        ...
                        <form class="space-y-5 dark:text-white" @submit.prevent="router.push('/')">
                            ...
                            <button type="submit" class="btn btn-gradient !mt-6 w-full border-0 uppercase shadow-[0_10px_20px_-10px_rgba(44,95,224,0.44)]">
                                Sign Up
                            </button>
                        </form>
                        ...
                        <div class="text-center dark:text-white">
                            ...
                            <NuxtLink to="/auth/boxed-signin" class="uppercase text-primary underline transition hover:text-black dark:hover:text-white">
                                SIGN IN
                            </NuxtLink>
                        </div>
                    </div>
