<template>
    <div class="relative flex min-h-screen items-center justify-center overflow-hidden">
        <div
            class="px-6 py-16 text-center font-semibold before:container before:absolute before:left-1/2 before:aspect-square before:-translate-x-1/2 before:rounded-full before:bg-[linear-gradient(180deg,#2c5fe0_0%,rgba(44,95,224,0)_50.73%)] before:opacity-10 md:py-20"
        >
            <div class="relative">
                <img
                    :src="
                        store.theme === 'dark' || store.isDarkMode ? '/assets/images/error/maintenence-dark.svg' : '/assets/images/error/maintenence-light.svg'
                    "
                    alt="maintenence"
