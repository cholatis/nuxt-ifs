        ...
        <nav class="sidebar fixed bottom-0 top-0 z-50 h-full min-h-screen w-[260px] shadow-[5px_0_25px_0_rgba(94,92,154,0.1)] transition-all duration-300">
            <div class="h-full bg-white dark:bg-[#0e1726]">
                <div class="flex items-center justify-between px-4 py-3">
                    <NuxtLink to="/dashboard" class="main-logo flex shrink-0 items-center">
                        <NexLogo />
                    </NuxtLink>
                    <a
                        href="javascript:;"
                ...
                <client-only>
                    ...
                    >
                        <ul class="relative space-y-0.5 p-4 py-0 font-semibold">
                            ...
                            <!-- ===== LENDER MENU ===== -->
                            <template v-if="authStore.isLender">
                                <h2 class="-mx-4 mb-1 flex items-center bg-white-light/30 px-7 py-3 font-extrabold uppercase dark:bg-dark dark:bg-opacity-[0.08]">
                                    <icon-minus class="hidden h-5 w-4 flex-none" />
                                    <span>Factoring</span>
                                </h2>
                                <li class="menu nav-item">
                                    <NuxtLink to="/lender/request-list" class="nav-link group" @click="toggleMobileMenu">
                            ...
                            <template v-else-if="authStore.isSupplier">
                                ...
                                <li class="menu nav-item">
                                    <NuxtLink to="/supplier/request-list" class="nav-link group" @click="toggleMobileMenu">
                                        <div class="flex items-center">
                                            <icon-menu-invoice class="shrink-0 group-hover:!text-primary" />
                                            <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">
                                                Request List
                                ...
                                <li class="menu nav-item">
                                    <NuxtLink to="/supplier/new-line-application" class="nav-link group" @click="toggleMobileMenu">
                                        <div class="flex items-center">
                                ...
                                <li class="menu nav-item">
                                    <NuxtLink to="/supplier/new-factoring-request" class="nav-link group" @click="toggleMobileMenu">
                                        <div class="flex items-center">
                                            <icon-menu-invoice class="shrink-0 group-hover:!text-primary" />
                                            <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">
                            ...
                            <template v-else>
                                <li class="menu nav-item">
                                    ...
                                    <vue-collapsible :isOpen="activeDropdown === 'dashboard'">
                                        <ul class="sub-menu text-gray-500">
                                            <li><NuxtLink to="/dashboard" @click="toggleMobileMenu">{{ $t('sales') }}</NuxtLink></li>
                                            <li><NuxtLink to="/analytics" @click="toggleMobileMenu">{{ $t('analytics') }}</NuxtLink></li>
                                            <li><NuxtLink to="/finance" @click="toggleMobileMenu">{{ $t('finance') }}</NuxtLink></li>
                                            <li><NuxtLink to="/crypto" @click="toggleMobileMenu">{{ $t('crypto') }}</NuxtLink></li>
                                        </ul>
                                    </vue-collapsible>
                                </li>

                                <!-- GEC only: Factoring + User Management -->
                                <template v-if="authStore.isGEC">
                                    ...
                                    <li class="menu nav-item">
                                        <NuxtLink to="/gec/request-list" class="nav-link group" @click="toggleMobileMenu">
                                            <div class="flex items-center">
                                                <icon-menu-invoice class="shrink-0 group-hover:!text-primary" />
                                                <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">
                                                    Request List
                                    ...
                                    <li class="menu nav-item">
                                        <button
                                            type="button"
                                            class="nav-link group w-full"
                                            :class="{ active: activeDropdown === 'user_management' }"
                                            @click="activeDropdown === 'user_management' ? (activeDropdown = null) : (activeDropdown = 'user_management')"
                                        >
                                            <div class="flex items-center">
                                            ...
                                            <div :class="{ '-rotate-90 rtl:rotate-90': activeDropdown !== 'user_management' }">
                                                <icon-caret-down />
                                            </div>
                                        </button>
                                    ...
                                    <li class="menu nav-item">
                                        ...
                                        <vue-collapsible :isOpen="activeDropdown === 'master'">
                                            <ul class="sub-menu text-gray-500">
                                                <li><NuxtLink to="/gec/master/consent" @click="toggleMobileMenu">Consent</NuxtLink></li>
                                            </ul>
                                        </vue-collapsible>
                                    </li>

                                    <!-- CRM Section (GEC only) -->
                                    <h2 class="-mx-4 mb-1 flex items-center bg-white-light/30 px-7 py-3 font-extrabold uppercase dark:bg-dark dark:bg-opacity-[0.08]">
                                        <icon-minus class="hidden h-5 w-4 flex-none" />
                                        <span>CRM</span>
                                    </h2>
                                    <li class="menu nav-item">
                                        <NuxtLink to="/gec/contacts" class="nav-link group" @click="toggleMobileMenu">
                                            <div class="flex items-center">
                                    ...
                                    <li class="menu nav-item">
                                        <NuxtLink to="/gec/activities" class="nav-link group" @click="toggleMobileMenu">
                                            <div class="flex items-center">
                                ...
                                <li class="menu nav-item">
                                    <button
                                        type="button"
                                        class="nav-link group w-full"
                                        :class="{ active: activeDropdown === 'credit_application' }"
                                        @click="activeDropdown === 'credit_application' ? (activeDropdown = null) : (activeDropdown = 'credit_application')"
                                    >
                                        <div class="flex items-center">
                                            <icon-menu-invoice class="shrink-0 group-hover:!text-primary" />
                                            <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">
                                        ...
                                        <div :class="{ '-rotate-90 rtl:rotate-90': activeDropdown !== 'credit_application' }">
                                            <icon-caret-down />
                                        </div>
                                    </button>
                                    <vue-collapsible :isOpen="activeDropdown === 'credit_application'">
                                        <ul class="sub-menu text-gray-500">
                                            <li><NuxtLink to="/po_list" @click="toggleMobileMenu">PO List</NuxtLink></li>
                                            <li v-if="authStore.isGEC"><NuxtLink to="/invoice_list" @click="toggleMobileMenu">Invoice List</NuxtLink></li>
                                            <template v-if="!authStore.isGEC">
                                                <li><NuxtLink to="/new_line_application" @click="toggleMobileMenu">New Line Application</NuxtLink></li>
                                                <li><NuxtLink to="/new_factoring_request" @click="toggleMobileMenu">New Factoring Request</NuxtLink></li>
                                            </template>
                                        </ul>
                                    </vue-collapsible>
                                </li>
                            ...
                            <li class="menu nav-item">
                                <button type="button" class="nav-link group w-full" @click="handleLogout">
                                    <div class="flex items-center">
                                        <icon-logout class="shrink-0 group-hover:!text-primary" />
                                        <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">
                                            Logout
                                        </span>
                                    </div>
